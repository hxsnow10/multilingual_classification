...
ltp_model_path=os.path.dirname(os.path.realpath(__file__))+'/ltp/ltp_data/'

class Segmentor():

    def __init__(self, model_path=ltp_model_path):
...
'''
def segmentor():
    return Segmentor('ltp/ltp_data/')
def postagger():
    return Postagger('ltp/ltp_data/')
def dpparser():
    return Dpparser('ltp/ltp_data/')
'''
# thrift start
